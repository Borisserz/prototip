...
TAX_TYPES = ["НДС", "Налог на прибыль", "Подоходный налог", "Налог на недвижимость", "Земельный налог", "Экологический налог"]
...
def generate_docs(count=100):
    ...
    print(f"Успешно сгенерировано {count} документов в {DOCS_DIR}")
