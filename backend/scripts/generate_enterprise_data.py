...
def generate_enterprise_data():
    ...
    cities = {
        ...
        "Гомельская область": ["Гомель", "Мозырь", "Жлобин"],
        "Гродненская область": ["Гродно", "Лида", "Слоним"],
        "Витебская область": ["Витебск", "Орша", "Новополоцк"],
        "Могилевская область": ["Могилев", "Бобруйск", "Горки"],
        "г. Минск": ["Минск"],
    }
    tax_types = [
        "НДС",
    ...
    for i in range(1, 101):
        ...
        companies.append({"inn": inn, "name": name, "region": reg, "city": cit, "industry": ind})
    ...
    while current_date < end_date:
        ...
        for _ in range(random.randint(50, 150)):
            ...
            if (
                comp["industry"] == "IT"
                and current_date.year == 2022
                and current_date.month in [6, 7, 8, 9, 10]
            ):
