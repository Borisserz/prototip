...
def test_format_number_ru_spaces_and_suffix() -> None:
    ...
    # с total_debt резервный вариант в label (отдельный тест)
...
def test_get_russian_label_dataset_cols() -> None:
    ...
    # анти-english даже в резервный вариант
    # "debt" слово может остаться в резервный вариант для weird, но фраза Total Debt не должна
