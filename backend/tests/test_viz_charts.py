...
Ключевой тест: на sample.csv строятся 5-6+ графиков в едином стиле,
...
def test_five_six_graphs_on_sample_produce_previews(
    ...
    """Итоговый тест: 6 графиков + экспорт (как "на sample.csv строятся 5–6")."""
...
# =============================================================================
# Extensions: new chart types (area, scatter, waterfall) + penalties column + edges
# =============================================================================


def test_build_new_types_on_penalties_sample(sample_df: pd.DataFrame) -> None:
    """Новые типы должны строиться на обогащённом датасете (с penalties, region variety)."""
