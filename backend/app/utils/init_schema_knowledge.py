...
from app.services.rag_service import get_embeddings_model  # BUG 5.3 FIX: use cached singleton
...
def init_schema_knowledge():
    ...
    for model in catalog.models:
        ...
        data.append([uuid.uuid4().hex, model.name, model.description or "", content, emb])

    if data:
        ch_client.insert(
            "schema_knowledge",
            data,
            column_names=["id", "name", "description", "content", "embedding"],
        )
