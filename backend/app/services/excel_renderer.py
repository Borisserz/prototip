...
class ExcelRenderer:
    ...
    def render_json_to_excel(data_json: str, title: str = "Аналитический Отчет") -> bytes:
        ...
        try:
            ...
            title_cell.fill = PatternFill(start_color="4F46E5", end_color="4F46E5", fill_type="solid") # Indigo-600
            ...
            for col_num, column_title in enumerate(df.columns, 1):
                cell = ws.cell(row=2, column=col_num, value=column_title.replace('_', ' ').capitalize())
