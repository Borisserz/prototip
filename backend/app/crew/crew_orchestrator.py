...
agent_execution_duration = Histogram(
    "agent_execution_duration_seconds", "Time spent running the analytical crew", ["status"]
)
...
def run_analytical_crew(user_question: str) -> str:
    ...
    try:
        ...
        logger.info(
            ...
            extra={"event": "crew_execution", "duration_s": duration, "status": "success"},
        )
        ...
        logger.error(
            ...
            extra={"event": "crew_execution", "duration_s": duration, "status": "error"},
        )
