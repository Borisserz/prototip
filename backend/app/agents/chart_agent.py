...
Выбери от 1 до 3 подходящих chart_type из: bar, grouped_bar, stacked_bar, line, area, scatter, waterfall, horizontal_bar, donut, kpi, heatmap, treemap.
Если вопрос сложный, верни 2 или 3 разных графика, показывающих данные с разных ракурсов (например, KPI-карточку + график динамики).
...
"""
        ...
        reasoning = (
            f"Выбрано {len(final_specs)} графиков: " + 
            ", ".join([getattr(s, "rationale", "") for s in final_specs])
        )
