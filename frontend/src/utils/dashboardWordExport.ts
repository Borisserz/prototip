 ...
 *
 * Собирает Markdown из данных дашборда и отправляет его на серверный маршрут
 * POST /api/v1/export/report-docx . Графики передаются как ChartSpec +
