...
const STAGES: Stage[] = [
  ...
  { id: 'analysis',  label: 'ИИ Анализ',     icon: <Zap className="w-4 h-4" />,          detail: 'Глубокий анализ: инсайты, аномалии, тренды...' },
                ...
                <div className="relative flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">AI-генерация • ClickHouse • Plotly</p>
                    </div>
                  </div>
                  {!isGenerating && (
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-900/50 border border-white/5">
                      ...
                      <p className="text-xs text-slate-500">
                        ...
                        Среднее время генерации: <span className="text-violet-400 font-semibold">1–3 минуты</span>.
                      </p>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 px-4 py-3 rounded-xl bg-slate-900/50 border border-white/5">
                      ...
                      <p className="text-xs text-slate-400">
                        AI анализирует данные в ClickHouse, строит графики и генерирует аналитические выводы. Это занимает 1–3 минуты.
                      </p>
                    </div>
                  </div>
                )}
