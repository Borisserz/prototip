  ...
  return (
    <div className="relative w-full h-full bg-[#080d1a] overflow-hidden flex flex-col">
      ...
      <div className="relative flex-shrink-0 flex items-center justify-between px-10 pt-5 pb-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[9px] text-slate-500 tracking-wider">Enterprise Analytics</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 rounded-full bg-emerald-500/15 border border-emerald-500/25 text-[10px] text-emerald-400 font-medium">✓ Авто-генерация</div>
      ...
      <div className="relative flex-1 flex flex-col justify-center px-10 pb-4 gap-3">
        ...
        <div className="flex gap-4 mt-2">
          {[
            ...
            { label: 'модулей', value: '5', icon: Cpu, color: 'text-emerald-400' },
      ...
      <div className="relative flex-shrink-0 border-t border-white/5 bg-slate-950/40 px-10 py-3 flex items-center justify-between">
        <span className="text-[10px] text-slate-600">Prototip BI • Analytics Platform • Министерство по налогам и сборам РБ</span>
        <div className="flex items-center gap-2">
  ...
  return (
    <div className="relative w-full h-full bg-[#080d1a] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 flex gap-5 overflow-hidden">
          ...
          <div className="flex-[2] flex flex-col gap-3">
            ...
            {[
              ...
              { label: '5 агентов', desc: 'Модуль', icon: Activity, color: 'text-amber-400', bg: 'bg-amber-500/10 border-amber-500/20' },
      ...
      <div className="relative flex-shrink-0 border-t border-white/5 bg-slate-950/40 px-10 py-2.5 flex items-center justify-between">
        <span className="text-[10px] text-slate-600">Prototip BI • Analytics Platform</span>
    ...
    <div className="relative w-full h-full bg-[#080d1a] overflow-hidden flex flex-col">
      ...
      <div className="relative flex-1 flex flex-col px-10 py-5 gap-4 overflow-hidden">
        ...
        <div className="flex-shrink-0 grid grid-cols-3 gap-3">
          {[{ label: 'Методология', desc: 'Система Text-to-SQL + BI', icon: Cpu }, { label: 'Источник', desc: 'ClickHouse OLAP', icon: Activity }, { label: 'Охват', desc: 'Все регионы РБ', icon: Globe }]
      ...
      <div className="relative flex-1 flex flex-col px-10 py-4 gap-3 overflow-hidden">
        ...
        <div className="flex-shrink-0 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-3 flex items-center gap-3">
          ...
          <p className="text-xs text-slate-400 flex-1">
            {takeaways.length} выводов сформированы на основе Анализа налоговых данных Республики Беларусь (синтетический датасет)
          </p>
        </div>
      </div>
    ...
    <div className="relative w-full h-full bg-[#080d1a] overflow-hidden flex flex-col">
      ...
      <div className="relative flex-1 flex flex-col px-10 py-5 gap-4 overflow-hidden">
        ...
        <div className="flex-shrink-0 bg-slate-900/60 border border-white/8 rounded-xl p-3 flex items-center gap-3">
          ...
          <p className="text-[11px] text-slate-400">Рекомендации сформированы системой. Требуют экспертной валидации перед внедрением.</p>
        </div>
      </div>
