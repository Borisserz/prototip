...
/** Phase 6/9 — пошаговый мастер создания клиентского блока + инициализации ETL. */
export const CreateTenantWizard: React.FC<Props> = ({ isOpen, onClose, onCreated }) => {
  ...
  // Шаг 1: проверка read-only доступа к Postgres клиента (через временного клиента не нужно —
