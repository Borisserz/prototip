    ...
    def run(self, question: str, data: list[dict]) -> AnalysisResult:
        ...
        if not data:
            ...
            return AnalysisResult(
                insights=[
                    "Для данного вопроса не удалось получить строки данных из SQL.",
                    "Возможно, фильтры в сгенерированном запросе слишком строгие или за указанный период данные отсутствуют.",
                    "Попробуйте переформулировать вопрос (убрать ограничения по времени/региону/налогу).",
                ],
